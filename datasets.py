...
# Dataloaders = lambda args: myhidden_manifold(args,6,4)
# Dataloaders = lambda args: myhyperplanes(args, 3, 10)
Dataloaders = lambda args: mylinearly_separable(args, 6)
...
if __name__ == '__main__':
    trainloader, validloader, testloader = Dataloaders(Arguments())
    for feed_dict in tqdm(testloader):
